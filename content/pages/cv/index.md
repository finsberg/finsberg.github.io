...
Engineering Mathematics at NTNU in Trondheim and DTU in Copenhagen. My fields
of interests are mathematical modelling, geometric modelling and image
...
> [Transcript DTU](/assets/cv/transcripts_DTU.pdf)
...
- Fall 2020: Lecturer, [University of Oslo, Department of Informatics](https://www.mn.uio.no/ifi/english/)

> Lecturer and main course responsible for [IN1910 Programming with Scientific Application](https://www.uio.no/studier/emner/matnat/ifi/IN1910/h20/index.html). Responsible for lecturing, as well as most of the administrative task.


- Fall 2019: Lecturer, [University of Oslo, Department of Informatics](https://www.mn.uio.no/ifi/english/)
...
- 2019-2020: Research Scholar, [UC Berkeley Biengineering](http://bioeng.berkeley.edu)
...
[INF4331, Problem solving with high level languanges]
...
- Finsberg, H., Balaban, G., Rognes, M.E., Sundnes, J. and Wall, S., Patient-specific computational modeling of cardiac biomechanics via gradient based data assimilation, 8th World Congress of Biomechanics, Dublin, Ireland, [PDF](https://www.researchgate.net/publication/328733786_Patient-specific_computational_modeling_of_cardiac_biomechanics_via_gradient_based_data_assimilation)

- Finsberg, H., Aalen, J., Larsen, C. J., Remme E., Sundnes, J. Smiseth O. A, and Wall, S., Assessment of regional myocardial work through adjoint-based data assimilation, International Conference on Computational Science and Engineering, Oslo, Norway [PDF](https://www.researchgate.net/publication/328733792_Assessment_of_regional_myocardial_work_through_adjoint-based_data_assimilation)

-  Finsberg, H., Xi, C., Tan, J.L., Zhong, L., Sundnes, J.,
  Lee, L.C. and Wall, S.T.,, Mechanical Analysis of Pulmonary Hypertension via Adjoint based data assimilation of a Finite Element model, SB3C2017 Summer Biomechanics, Bioengineering and Biotransport ConferenceAt: Tucson, AZ, USA [PDF](https://www.researchgate.net/publication/325301179_MECHANICAL_ANALYSIS_OF_PULMONARY_HYPERTENSION_VIA_ADJOINT_BASED_DATA_ASSIMILATION_OF_A_FINITE_ELEMENT_MODEL)

- Finsberg, H., Balaban, G., Ross, S., Odland, H.H.,
  Sundnes, J. and Wall, S., Personalized Cardiac Mechanical Model using a High Resolution Contraction Field, Virtual Physiological Human 2016 conference, Amsterdam, Netherland [PDF](https://www.researchgate.net/publication/328733694_Personalized_Cardiac_Mechanical_Model_using_a_High_Resolution_Contraction_Field)

- Finsberg, H., Balaban, G., Ross, S., Odland, H.H.,
  Sundnes, J. and Wall, S., Personalization of a Cardiac Computational Model using Clinical Measurements, 28th Nordic Seminar on Computational Mechanics, Tallinn, Estonia [PDF](https://www.researchgate.net/publication/325301428_Personalization_of_a_Cardiac_Computational_Model_using_Clinical_Measurements)
...
- Optimization of a Spatially Varying Cardiac Contraction
parameter using the Adjoint Method, FEniCS Conference 2016, Oslo, Norway, [PDF](/assets/talks/fenics2016.pdf)

- What are all these models, and do we really need them? - Translating cardiac mechanical modeling into clinical applications, CCI Journal Club, Oslo University Hospital [PDF](/assets/talks/journal_club270317.pdf)

- Patient Constrained Ventricular Stress Mapping, MALT Conference, Lugano, Switzerland, 2015, [PDF](/assets/talks/malt010515.pdf)

- Personalization of a Cardiac Computational Model using Clinical Measurements, 28th Nordic Seminar on Computational Mechanics, Tallin, Estonia, 2015, [PDF](/assets/talks/nscm_2015.pdf)
